...
export type TrackId = 'PRODUCT_DELIVERY' | 'ACCOUNTABILITY' | 'CONTINUOUS_IMPROVEMENT' |
    'TEAMWORK' | 'BUSINESS_THINKING' | 'ANALYSIS_&_DESIGN' | 'LEADERSHIP';

export type Milestone = 0 | 1 | 2 | 3 | 4 | 5

export type MilestoneMap = {
  'PRODUCT_DELIVERY': Milestone,
  'ACCOUNTABILITY': Milestone,
  'CONTINUOUS_IMPROVEMENT': Milestone,
  'TEAMWORK': Milestone,
  'BUSINESS_THINKING': Milestone,
  'ANALYSIS_&_DESIGN': Milestone,
...
type Tracks = {|
  'PRODUCT_DELIVERY': Track,
  'ACCOUNTABILITY': Track,
  'CONTINUOUS_IMPROVEMENT': Track,
  'TEAMWORK': Track,
  'BUSINESS_THINKING': Track,
  'ANALYSIS_&_DESIGN': Track,
  'LEADERSHIP': Track,
|}
...
export const tracks: Tracks = {
  "PRODUCT_DELIVERY": {
    ...
    "category": "A",
    "description": "Values quality and craftsmanship",
    "milestones": [{
...
export const categoryColorScale = d3.scaleOrdinal()
  .domain(categoryIds)
  .range(['#FF94FE', '#AE83E9', '#5D63E2', '#083AD4', '#36A6FF', '#33CAC9', '#14BD6D', '#F7E948', '#FF8B1D']);

export const titles = [
  {label: 'Software Developer I', minPoints: 0, maxPoints: 16},
  {label: 'Software Developer II', minPoints: 17, maxPoints: 35},
  {label: 'Software Developer III', minPoints: 36, maxPoints: 57},
  {label: 'Software Developer IIII', minPoints: 36, maxPoints: 57},
  {label: 'Software Developer Lead', minPoints: 58, maxPoints: 89},
  {label: 'Software Architect I', minPoints: 58, maxPoints: 89},
  {label: 'Software Architect II', minPoints: 90},
  {label: 'Data Science I', minPoints: 90},
  {label: 'Data Science II', minPoints: 90}
];
